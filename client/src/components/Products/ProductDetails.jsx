...
import { fetchProductByDetails, fetchSimilarProducts } from "../../redux/slice/productSlice";
...
function ProductDetails({ productId }) {
    ...
    const { selectedProduct, loading, error, similarProducts } = useSelector((state) => {
        ...
        <div className="p-6">
            {
                selectedProduct && (
                    ...
                    <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
                        <div className="flex flex-col md:flex-row">  {/*this is where content goes*/}
                            {/* left thumbnails */}
                            ...
                            <div className="md:w-1/2">
                                <div className="mb-4">
                                    <img
                                        src={mainImage || "https://picsum.photos/500/500?random=1"}
                                        alt="Main Product"
                                    ...
                                    <div className="flex gap-2 mt-2">
                                        {
                                            selectedProduct.sizes.map((sizes) => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded border ${selectedSize === sizes ? "bg-black text-white" : null}`} >
                                                    {sizes}
                                                </button>
                                            ))
                                        }
                                ...
                                <div className="mt-10 text-gray-700">
                                    ...
                                    <table className="w-full text-left text-sm text-gray-600">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="py-1 capitalize">material</td>
                                                <td className="py-1 capitalize">{selectedProduct.material}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
